...
class ApiDocumentationControllerV2DisabledSpec extends UnitSpec
  ...
  private val definitionJsonContentV2Disabled = getResourceFileContent("/public/api/definitionV2Disabled.json")
  ...
  "DocumentationController" should {
    "serve definitionV2Enabled.json" in assertRoutedContent("/api/definition", definitionJsonContentV2Disabled)
